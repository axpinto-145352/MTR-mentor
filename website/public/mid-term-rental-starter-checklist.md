...
**Created by Michelle Romano — Mid-Term Mentor**
www.midtermmentor.com
...
- [ ] **Evaluate proximity to demand drivers**
...
- [ ] **Check local regulations for 30+ day rentals**
...
- [ ] **Assess property condition and layout**
...
## 2. Furnishing Essentials

- [ ] **Budget $3,000–$8,000 per bedroom (all-in)**
...
- [ ] **Prioritize the Big Three: mattress, sofa, WiFi**
...
- [ ] **List on Furnished Finder (primary platform)**
...
- [ ] **Cross-list on Zillow and one additional platform**
...
- [ ] **Professional photos — minimum 15–20 images**
...
- [ ] **Verify employment or assignment documentation**
...
- [ ] **Run background and eviction checks**
...
- [ ] **Collect first month's rent + security deposit before key handover**
...
- [ ] **Use a written lease with MTR-specific terms**
...
## Ready to Launch Your Mid-Term Rental?

Michelle walks through every item on this checklist during a free strategy call. Book yours at:

**www.midtermmentor.com/contact**

---

*© Mid-Term Mentor. All rights reserved.*
